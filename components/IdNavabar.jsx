...
const IdNavabar = () => {
  return (
    ...
    <div className='h-24 bg-blue-600 flex flex-row space-x-6 md:flex-row md:justify-center items-center md:space-x-32  px-4 md:px-64 py-2'>
        ...
        <div className='flex space-x-4 flex-row  md:pb-2 md:flex-1 md:flex'>
            <div className=' flex  flex-row  font-semibold text-white md:pb-2 md:hidden space-x-2 '>
                ...
                <Link className=""  rel="noopener noreferrer" href='https://goo.gl/maps/gSJ3rXaMxuzDrGVr6' target="_blank">Encuentranos aqui</Link>
            </div>
        </div>
