  ...
  render() {
    return (
      <Html lang="es">
        ...
        <meta
          name="description"
          content="Ferreteria portales, Aridos, Materiales, nos encargamos de atender a todos nuestro clientes
con el fin de entregarles una solucion. Nos ubicamos en Av diego portales 4497"
        />
        <meta
          property="og:title"
          content="Ferreteria Portales | Diego Portales | Puente Alto"
        />
        <meta
          name="title"
          content="Ferreteria Portales | Diego Portales | Puente Alto"
        ...
        <link rel="canonical" href="https://www.ferreteriasportales.com/" />
